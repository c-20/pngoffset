...
#define IFNQOR2(v, n1, n2)              IF (v NQ n1 OR v NQ n2)
#define IFNQOR3(v, n1, n2, n3)          IF (v NQ n1 OR v NQ n2 OR v NQ n3)
#define IFNQOR4(v, n1, n2, n3, n4)      IF (v NQ n1 OR v NQ n2 OR v NQ n3 OR v NQ n4)
#define IFNQOR5(v, n1, n2, n3, n4, n5)  IF (v NQ n1 OR v NQ n2 OR v NQ n3 OR v NQ n4 OR v NQ n5)
#define IFNQAND2(v, n1, n2)             IF (v NQ n1 AND v NQ n2)
#define IFNQAND3(v, n1, n2, n3)         IF (v NQ n1 AND v NQ n2 AND v NQ n3)
#define IFNQAND4(v, n1, n2, n3, n4)     IF (v NQ n1 AND v NQ n2 AND v NQ n3 AND v NQ n4)
#define IFNQAND5(v, n1, n2, n3, n4, n5) IF (v NQ n1 AND v NQ n2 AND v NQ n3 AND v NQ n4 AND v NQ n5)
...
#define IFNQ1(v, n1)                   IFNQ(v, n1)
#define IFNQ2(v, n1, n2)               IFNQOR2(v, n1, n2)
#define IFNQ3(v, n1, n2, n3)           IFNQOR3(v, n1, n2, n3)
#define IFNQ4(v, n1, n2, n3, n4)       IFNQOR4(v, n1, n2, n3, n4)
#define IFNQ5(v, n1, n2, n3, n4, n5)   IFNQOR5(v, n1, n2, n3, n4, n5)
#define IF1NQ(v1, n)                   IFNQ(n, v1)
#define IF2NQ(v1, v2, n)	       IFNQAND2(n, v1, v2)
#define IF3NQ(v1, v2, v3, n)           IFNQAND3(n, v1, v2, v3)
#define IF4NQ(v1, v2, v3, v4, n)       IFNQAND4(n, v1, v2, v3, v4)
#define IF5NQ(v1, v2, v3, v4, v5, n)   IFNQAND5(n, v1, v2, v3, v4, v5)
#define IFEQEQ(v1, n1, v2, n2)         IF (v1 EQ n1 AND v2 EQ n2)
#define EFEQEQ(v1, n1, v2, n2)         EF (v1 EQ n1 AND v2 EQ n2)
#define IFNQEQ(v1, n1, v2, n2)         IF (v1 NQ n1 AND v2 EQ n2)
#define EFNQEQ(v1, n1, v2, n2)         EF (v1 NQ n1 AND v2 EQ n2)
#define IFEQNQ(v1, n1, v2, n2)         IF (v1 EQ n1 AND v2 NQ n2)
#define EFEQNQ(v1, n1, v2, n2)         EF (v1 EQ n1 AND v2 NQ n2)
#define IFNQNQ(v1, n1, v2, n2)         IF (v1 NQ n1 AND v2 NQ n2)
#define EFNQNQ(v1, n1, v2, n2)         EF (v1 NQ n1 AND v2 NQ n2)
...
#define OPENBINARYFILE(f) fopen(f, "rb")
#define SAVEBINARYFILE(f) fopen(f, "wb")
...
#define CLOSEBINARYFILE(f) fclose(f)
...
#define FREEMEM(v)	UNMEM(v)
#define NOMEM(v)	UNMEM(v)
#define INTMEM(n)	INMEM(n)
#define SIZEMEM(type)	(type *)MEM(sizeof(type))
#define COUNTMEM(type, n)  (type *)MEM(sizeof(type) * n)
...
#define PREFIXEQ(str, prefix)		STRPREFIXEQ(str, prefix)
#define IFPREFIXEQ(str, prefix)		IF STRPREFIXEQ(str, prefix)
#define EFPREFIXEQ(str, prefix)		EF STRPREFIXEQ(str, prefix)
// etc...
...
#define OREQ4(dv, a, b, c, d)	  (dv EQ a OR dv EQ b OR dv EQ c OR dv EQ d)
#define OREQ5(dv, a, b, c, d, e)  (dv EQ a OR dv EQ b OR dv EQ c OR dv EQ d OR dv EQ e)
#define ORNQ2(dv, a, b)		  (dv NQ a OR dv NQ b)
#define ORNQ3(dv, a, b, c)	  (dv NQ a OR dv NQ b OR dv NQ c)

#define IFEITHER2(dv, a, b)          IF OREQ2(dv, a, b)
#define IFEITHER3(dv, a, b, c)       IF OREQ3(dv, a, b, c)
#define IFEITHER4(dv, a, b, c, d)    IF OREQ4(dv, a, b, c, d)
#define IFEITHER5(dv, a, b, c, d, e) IF OREQ5(dv, a, b, c, d, e)
#define EFEITHER2(dv, a, b)          EF OREQ2(dv, a, b)
#define EFEITHER3(dv, a, b, c)       EF OREQ3(dv, a, b, c)
#define EFEITHER4(dv, a, b, c, d)    EF OREQ4(dv, a, b, c, d)
#define EFEITHER5(dv, a, b, c, d, e) EF OREQ5(dv, a, b, c, d, e)
...
#define NEWENV(n, v)	setenv(n, v, 0)
// ^ SETENV will overwrite by default, NEWENV will only create
...
#define LOG1(str, v1)			printf(str, v1)
//  LOG0
...
//#define LOGCH(ix)		fputc(ix, stdout) // ...nope
//#define LOGCH(ix)		putchar(ix) // .... um wut
// NOTE! no fflush ! faster tho
...
#define $V	argv // $1 is $V[1]
//#define $V(i)	argv[i] // $1 is $V(1)
...
#define DRxc(xc)	LOG(DRFGC); EXTCH(xc); LOG(OFFC);
#define Yxc(xc)		LOG(YFGC); EXTCH(xc); LOG(OFFC);
#define DYxc(xc)	LOG(DYFGC); EXTCH(xc); LOG(OFFC);
#define Gxc(xc)		LOG(GFGC); EXTCH(xc); LOG(OFFC);
#define DGxc(xc)	LOG(DGFGC); EXTCH(xc); LOG(OFFC);
#define Cxc(xc)		LOG(CFGC); EXTCH(xc); LOG(OFFC);
#define DCxc(xc)	LOG(DCFGC); EXTCH(xc); LOG(OFFC);
#define Bxc(xc)		LOG(BFGC); EXTCH(xc); LOG(OFFC);
#define DBxc(xc)	LOG(DBFGC); EXTCH(xc); LOG(OFFC);
#define Mxc(xc)		LOG(MFGC); EXTCH(xc); LOG(OFFC);
#define DMxc(xc)	LOG(DMFGC); EXTCH(xc); LOG(OFFC);
...
// #define TAB		'\t' // ... used in STDIO ?
// #define TABKEY	'\t' // ... seems to become literal tab
// #define TABKEY	'\x9' // maybe that'll work .... nope
// #define TABKEY		'\011' // maybe that'll work .... nope
// #define TABKEY		'~' // broken!!!!
#define BACKSPACE	'\b'
